...
export const founders: Founder[] = [
  ...
  },
  {
    ...
    role: 'HR Leader ',
    bio: 'Passionate about teamwork, communication, and helping members reach their full potential. I love solving problems — any kind of challenge inspires me to think creatively and find smart solutions. My goal is to build a positive environment where innovation and scientific curiosity can thrive.',
    imageId: 'founder-7',
  },
  {
    id:'founder-8',

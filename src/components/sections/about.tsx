      ...
      <div className="container">
        ...
        <div className="mt-28">
          ...
          >
            ...
            {/* Carousel Container */}
            <div className="relative w-full max-w-[340px] sm:max-w-[440px] md:max-w-[620px] lg:max-w-[820px] xl:max-w-[950px] h-[5500px] md:max-h-[650px] lg:max-h-[700px] flex items-center justify-center overflow-hidden">
              <AnimatePresence initial={false}>
                {founders.map((founder, index) => {
                  ...
                  return (
                    ...
                    >
                      <Card className="text-center shadow-lg hover:shadow-xl transition-all duration-300 bg-background border border-border/40 h-[300px] md:h-[500px] lg:h-[500px] flex flex-col justify-between">
                        <CardHeader>

      ...
      <div className="container">
        ...
        <div className="mt-28">
          ...
          >
            ...
            {/* Carousel Container */}
            <div className="relative w-full max-w-[340px] sm:max-w-[440px] md:max-w-[620px] lg:max-w-[820px] xl:max-w-[950px] h-[520px] md:max-h-[500px] lg:max-h-[500px] flex items-center justify-center overflow-hidden">

          ...
          <div className="flex flex-wrap items-end justify-center text-center md:justify-start md:text-left space-x-2">
            <div className="inline-block">
              <TypingText
                ...
                showCursor={true}
                cursorCharacter="|"
                className="font-bold text-4xl sm:text-5xl md:text-6xl lg:text-6xl leading-none drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]"
                textColors={['#3b82e2', '#8b5cf6', '#06b6d4']}
                variableSpeed={{ min: 50, max: 120 }}
              />
            </div>
            <h1 className="font-headline font-bold tracking-tight text-foreground text-2xl sm:text-3xl md:text-5xl lg:text-6xl leading-none drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]">
